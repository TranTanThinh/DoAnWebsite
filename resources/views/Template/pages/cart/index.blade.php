        ...
        <div class="container">
                                ...
                                @foreach ($viewData['products'] as $product)
                                    <tr class="text-center">
                                        <td class="product-remove"><a
                                                href="{{ route('cart.delete', ['id' => $product->getProductId()]) }}"><span
            ...
            <div class="row justify-content-end">
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    <form id="promotion-form" method="POST" action="{{ route('cart.applyPromotion') }}">
                        @csrf
                        <div class="form-group">
                            <label for="promotion-code">Coupon code</label>
                            <input type="text" id="promotion-code" class="form-control text-left px-3" placeholder="">
                        </div>
                        <p>
...
<script>
    document.getElementById('promotion-form').addEventListener('submit', function(e) {
        ...
        let promoCode = document.getElementById('promotion-code').value;
        ...
        fetch('{{ route('cart.applyPromotion') }}', {
            ...
            .then(data => {
                if (data.success) {
                    // Cập nhật giao diện
                    document.getElementById('discount-amount').innerText = `$${data.discountAmount}`;
                    document.getElementById('total-price').innerText = `$${data.totalAfterDiscount}`;
                } else {
